...
// on every render — keeps React from resetting it as a brand-new component.
function Mark({ d, className, stroke, opacity }) {
  return (
...
export default function CrosshairMarks({ variant = 'solid' }) {
  ...
  const marks = { stroke, opacity }

  return (
    <>
      <Mark d="M0 0 H6 M0 0 V6" className="top-[5px] left-[5px]" {...marks} />
      <Mark d="M10 0 H4 M10 0 V6" className="top-[5px] right-[5px]" {...marks} />
      <Mark d="M0 10 H6 M0 10 V4" className="bottom-[5px] left-[5px]" {...marks} />
      <Mark d="M10 10 H4 M10 10 V4" className="bottom-[5px] right-[5px]" {...marks} />
    </>
  )
}
